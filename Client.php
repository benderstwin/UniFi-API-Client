...
class Client
{
     ...
     * private properties
     */
    protected $baseurl            = getenv('ENV_URL');
    protected $user               = getenv('ENV_USER');
    protected $password           = getenv('ENV_PWD');
    protected $site               = getenv('ENV_SITE');
    protected $version            = getenv('ENV_VER');
    protected $debug              = getenv('ENV_DEBUG');
    ...
    private $curl_ssl_verify_host = getenv('ENV_HSSL');
